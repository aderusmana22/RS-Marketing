                            ...
                            <tr>
                                        ...
                                        <div class="ms-3">
                                            <div class="user-meta-info">
                                                <h6 class="user-name mb-0" data-name="{{ $user->name }}">
                                                    {{ $user->name }}</h6>
                                                <h6 class="user-nik fs-3"
                                                    data-nik="{{ $user->nik }}">{{ $user->nik }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <h6 class="usr-email-addr"
                                        data-email="{{ $user->email }}">{{ $user->email }}</h6>
                                </td>
                                <td>
                                    <h6 class="usr-department"
                                        data-department-id="{{ $user->department->id }}">{{ $user->department->name }}</h6>
                                </td>
                                <td>
                                    <h6 class="usr-position"
                                        data-position-id="{{ $user->position->id }}">{{ $user->position->name }}</h6>
                                </td>
                                <td>
                                    <h6 class="usr-section"
                                        data-section-id="{{ $user->section->id }}">{{ $user->section->name }}</h6>
                                </td>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="tb-nik"
                                                    placeholder="NIK" name="nik" autocomplete="on">
